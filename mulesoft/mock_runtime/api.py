...
class LogiaOrderParser:
    ...
    def parse(
        ...
        *,
        ...
        item = ""
        qty_match = re.search(
            r"\b(?:qty|quantity|amount)\s*(?:around|about|approximately|approx\.?)?\s*[:=]?\s*(\d+(?:\.\d+)?)\b",
            cleaned,
            re.IGNORECASE,
        )
        if qty_match:
            ...
            item = re.sub(
                r"\b(please|pls|can|could|you|we|need|needs|order|restock|stock|buy|purchase|supplier|from|for|of|the|a|an)\b",
                " ",
                before_qty,
                flags=re.IGNORECASE,
            )
        ...
        due_time = ""
        due_match = re.search(
            r"\b(?:due|by|in|within)\s+([^,.;]+?)(?=[,.;]|\s+\b(?:from|supplier|email|manager|note|the)\b|$)",
            cleaned,
            re.IGNORECASE,
        )
        if due_match:
    ...
    def _clean_item(value: str) -> str:
        ...
        value = re.sub(
            r"\b(?:please|pls|can|could|you|we|of|the|a|an)\b",
            " ",
            value,
            flags=re.IGNORECASE,
        )
    ...
    def pending_action_from_draft(cls, draft: LogiaOrderDraft) -> dict[str, Any]:
        ...
        email_body = "\n".join(
            [
                "Hello,",
                "",
                "Could you please confirm availability, price, and earliest delivery for the request below?",
                "",
                f"- Item: {draft.item}",
                ...
                "",
                "This request was approved by our operations manager through Logia.",
                "",
                "Best regards,",
                "Operations Manager",
                "Logia",
            ...
            },
            {
                ...
                "text": {
                    ...
                    "text": (
                        ...
                        "Hello, could you please confirm availability, price, "
                        "and earliest delivery for this request?\n\n"
                        "Best regards,\nOperations Manager"
                    ),
                },
            },
