...
| ---------- | -------------------------------------------- | ------------------------------- | ----------------------------------------------------- |
| `Entity`   | `HOSP-LOGIA-PRIVATE`                         | organization                    | Large private hospital campus                         |
...
| `Approval` | `approval-logia-hospital-001`                | operations manager approval     | Demo approval record                                  |
| `Action`   | `action-logia-hospital-slack-001`            | `SEND_SLACK_ALERT`              | Live harness approved channel action                  |
| `Action`   | `action-logia-hospital-whatsapp-001`         | `SEND_WHATSAPP_ALERT`           | Live harness approved channel action                  |
| `Outcome`  | `outcome-action-logia-hospital-slack-001`    | Slack delivery outcome          | `SENT` or honest `MOCK_SENT`                          |
| `Outcome`  | `outcome-action-logia-hospital-whatsapp-001` | WhatsApp-style delivery outcome | `SENT` or honest `MOCK_SENT`                          |
...
| Case ID | Situation                   | Expected Logia behavior                                                 |
| ------- | --------------------------- | ----------------------------------------------------------------------- |
