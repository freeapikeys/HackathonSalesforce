# Logia Demo Narrative

## Product Pitch

Logia is a Salesforce and Agentforce command center that turns messy
...
Logia reveals the conflict. The Customer Trust Agent sees a complaint
...
The extended version starts by showing that Logia is profile-driven, not
...
blindly escalating every partner case, Logia narrows action to the affected
...
Do not pitch "lots of bots." Pitch one governed Logia command center:
...
4. Open the command center in mock mode with the seeded Logia fixture.
...
- Logia is not a generic chatbot.
