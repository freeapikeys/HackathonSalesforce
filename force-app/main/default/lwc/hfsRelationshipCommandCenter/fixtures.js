...
function buildTerrainCaseState(overrides) {
  return {
    ...
    productContext: {
      ...nexavenuCaseState.productContext,
...
const airMauritiusCaseState = buildTerrainCaseState({
  ...
  productContext: {
    ...
    shelfArea: "Passenger recovery desk"
  },
  stock: [
...
const constanceHospitalityCaseState = buildTerrainCaseState({
  ...
  productContext: {
    ...
    shelfArea: "Revenue operations workspace"
  },
  stock: [
